...
var _videos = require("../views/Videos");
...
class Main {
    ...
    activeFunctions() {
        (0, _configJs.getVideos)().then((data)=>{
            const { videos  } = data;
            (0, _videosDefault.default).render(data);
        });
      ...
      <main>
          <section>
              <div class="container">
                ...
                ${(0, _videosDefault.default).render()}
              </div>
          </section>
...
},{"./components/Nav":"gUPQu","./components/HeaderMain":"f5Kds","./components/Footer":"8rFjb","./components/SectionHeader":"2taZf","./components/ViewAll":"alKS9","../config.js":"4Wc5b","../views/PopularMovies":"bQdJe","../views/BestComedies":"29L8v","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../views/ActionAndAdventure":"blEkO","axios":"jo6P5","../views/Videos":"65lVT"}],"gUPQu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Nav {
    render() {
...
},{"../api.js":"6yDOL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"65lVT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _apiJs = require("../api.js");
class Videos {
